...
_scRNAseqApp_ bowrrow the power of _shinymanager_ package for user management.
...
```{r, out.width ='80%', out.height ='80%', fig.align='center', fig.cap='Administrator mode page.', echo = FALSE}
knitr::include_graphics(system.file('vignettes', 'administrator_mode.jpg', package = 'scRNAseqAppBioc2023Workshop'), rel_path = FALSE)
```
...
```{r, out.width ='80%', out.height ='80%', fig.align='center', fig.cap='Change the protection status for a data.', echo = FALSE}
knitr::include_graphics(system.file('vignettes', 'change_the_status_protection.png', package = 'scRNAseqAppBioc2023Workshop'), rel_path = FALSE)
```
...
```{r, out.width ='80%', out.height ='80%', fig.align='center', fig.cap='Change the user privileges.', echo = FALSE}
knitr::include_graphics(system.file('vignettes', 'user_management.jpg', package = 'scRNAseqAppBioc2023Workshop'), rel_path = FALSE)
```

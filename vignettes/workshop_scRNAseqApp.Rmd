...
![administrator mode page](`r system.file('vignettes', 'administrator_mode.jpg', package = 'scRNAseqAppBioc2023Workshop')`)
...
![change the protection status for a data](`r system.file('vignettes', 'change_the_status_protection.png', package = 'scRNAseqAppBioc2023Workshop')`)
...
![change the user privileges](`r system.file('vignettes', 'user_management.jpg', package = 'scRNAseqAppBioc2023Workshop')`)
...
```{r pbmc_seurat}
appconf <- createAppConfig(
  title="pbmc small CD4 subset",
  destinationFolder = "pbmc_cd4",
  species = "Homo sapiens",
  doi="10.1038/nbt.3192",
  datatype = "scRNAseq")
...
appconf <- createAppConfig(
  title="pbmc scMultiome",
  destinationFolder = "pbmc_multiome",
  species = "Homo sapiens",
  doi="10.1038/nbt.3192",
  datatype = "scMultiome")
